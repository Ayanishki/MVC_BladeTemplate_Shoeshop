      ...
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
            ...
            <form action="{{ route('product.update', $product->ProID) }}" method="POST" class="row" enctype="multipart/form-data">
                @csrf
                @method('PUT')
              ...
              <div class="form-group col-md-3">
                ...
                <input value="{{$product->ProName}}" name="name" class="form-control" type="text">
              </div>
              <div class="form-group col-md-3">
